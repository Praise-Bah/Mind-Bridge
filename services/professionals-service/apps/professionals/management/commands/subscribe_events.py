"""Redis Pub/Sub event subscriber daemon for professionals-service."""
import json
import logging
import signal
import sys
...
from apps.professionals.event_handlers import EVENT_HANDLERS
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write('professionals-service event subscriber started.')
