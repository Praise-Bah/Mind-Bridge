...
export default function GoogleAuthButton({ 
  ...
  const handleCustomClick = async () => {
    if (!clientId) {
      toast.error('Google Sign-In not configured. Add VITE_GOOGLE_CLIENT_ID to frontend/.env')
    ...
    try {
      ...
      window.google.accounts.id.prompt(() => {
        // Prompt callback - loading will be handled by the initialize callback
      })
  ...
  return (
    <div className="w-full">
      ...
      <div 
        ref={buttonRef} 
        className="w-full flex justify-center [&>div]:!w-full [&_iframe]:!w-full [&>div]:!rounded-full"
